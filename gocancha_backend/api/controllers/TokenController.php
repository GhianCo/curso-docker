...
class TokenController { 
    ...
    public function listarPorPaginacion($busqueda,$pagina,$registros) {
      ...
      if($busqueda != REST_TODOS){
      	$sqlWhere[] = array('field'=>'token_descripcion','value'=>$busqueda,'operator'=>'=');
      }
    	$array_salida = Token::getByFields($sqlWhere,array(),($pagina-1)*$registros,$registros);
    ...
    public function getAllActivos() {
    	...
    	$datos=$array_salida['token_array'];
    	$data['mensajes'] = $mensajes;
    	$data['tipo'] = $tipo;
    	$data['data'] = $datos;
    	return $data;
