...
/** Peticiones */ 
 $app->post('/clienteproveedor','add'); 
 $app->put('/clienteproveedor','update'); 
 $app->get('/clienteproveedor/{id}', 'getById'); 
 $app->delete('/clienteproveedor/{id}', 'delete'); 
 ...
 function add($request, $response, $args) { 
 	...
 	$ctrl = new ClienteproveedorController(); 
